                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item dropdown">
                                    <Link className="nav-link dropdown-toggle" href="/" id="categoryDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Category
                                    </Link>
                                    <ul className="dropdown-menu" aria-labelledby="categoryDropdown" style={{height: 'calc( 5 * 100% )', overflow:'auto'}}>
                                        ...
                                        <li><Link className="dropdown-item" value="general" to="/general">General</Link></li>
